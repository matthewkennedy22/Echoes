...
const TESTS = [
  ...
  },
  {
    ...
    cases: [
      ...
      { q: "Show me your portrait.", wantPortrait: true, label: "portrait request" },
      {
        q: "Describe seeing Yosemite Valley for the first time.",
        expectImage: /yosemite|el-capitan|half-dome|bridalveil|falls|mariposa/,
        banPortrait: true,
        label: "Yosemite → valley image or none",
      },
      {
        q: "What did Yosemite Falls look like?",
        banPortrait: true,
        expectImage: /falls|bridalveil|yosemite/,
        label: "falls look-like → waterfall image, not portrait",
      },
      {
        q: "Tell me about camping with Roosevelt.",
        expectImage: /roosevelt/,
        banPortrait: true,
        label: "Roosevelt → Glacier Point image or none",
      },
      {
        q: "Tell me a fun fact about your Sierra days.",
        banUnrelatedImages: true,
        label: "fun fact → no stray images",
      },
    ],
