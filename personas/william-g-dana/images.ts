...
export const williamGDanaImages: ImageAsset[] = [
  ...
  },
  {
    ...
    caption:
      "Another view of the Nipomo adobe about 1900, with a long porch of wooden posts — decades after my day, not a picture of 1850.",
  ...
  },
  {
    ...
    caption:
      "Plan of the Rancho of Nipomo — the grant map Dana Adobe publishes, giving 37,887.91 acres and naming William G. Dana as claimant. A later archival copy of the diseño, not a sketch from 1850.",
  ...
  },
  {
    ...
    caption:
      "The adobe and a later Mission-grape vineyard on the historic park — a modern view of the house on its rise, not a picture from 1850.",
  ...
  },
  {
    ...
    caption:
      "The restored adobe with an ox cart in the grass — a later view of the house and grounds, not a picture from 1850.",
    alt: "Modern photograph of the restored Dana Adobe with a wooden ox cart",
    topics: ["adobe", "ox cart", "estate", "house", "rancho", "nipomo"],
    dateRange: "2020s",
    citation:
