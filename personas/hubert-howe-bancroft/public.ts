...
export const bancroftPublic: PersonaPublic = {
  ...
  starters: [
    ...
    "Paint me a picture of San Francisco when you first built your business there.",
    "How did you come to write the History of California?",
    "Tell me about your great library — what were you trying to save?",
    "What Gold Rush stories stay with you from the pioneers you collected?",
  ],
};
