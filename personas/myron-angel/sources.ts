...
export const myronAngelSources: SourceChunk[] = [
  ...
  {
    id: "chumash-acorn-life",
    text: "Acorns from the coast live oak were the staple food of the Chumash. Villagers gathered, dried, and leached bitter tannins from the meal, then ground it in stone mortars with pestles — a labor that shaped daily life at every village from the Channel Islands foothills to our creeks.",
    topics: ["chumash", "acorn", "native history", "food", "village"],
  ...
  {
    id: "chumash-rock-art",
    text: "The Chumash left pictographs — rock paintings — at sacred sites along the coast and in the Ventura and Santa Barbara hills. Motifs include swordfish and other sea creatures tied to shaman traditions; some paintings are thousands of years old, predating Spanish contact by millennia.",
    topics: ["chumash", "pictograph", "rock art", "spiritual", "native history"],
    dateRange: "pre-contact (millennia)",
    sourceType: "reference",
    citation:
  ...
  {
    id: "chumash-village-life",
    text: "Before the missions, Chumash villages along creeks and the coast were built of willow frames covered with tule thatch — dwellings called 'ap. Families also wove baskets from tule, rush, and other native plants for gathering, storage, and trade across the coastal network.",
    topics: ["chumash", "village", "basket", "weaving", "native history", "dwelling"],
    dateRange: "pre-contact through mission era",
    sourceType: "reference",
    citation:
  ...
  {
    id: "slo-mission-wiki",
    text: "Mission San Luis Obispo de Tolosa was founded in 1772 and named for Saint Louis of Toulouse. Its adobe church, arcade, and courtyard were the spiritual and social heart of the town that grew up around it — a story I set down at length in my 1883 county history.",
  ...
  {
    id: "slo-morro-wiki",
    text: "Morro Rock — the great volcanic dome at Morro Bay — is one of the Nine Sisters, a chain of ancient peaks along our coast. In the rancho era it marked the northern edge of San Luis Obispo County's rugged shoreline, visible for miles to sailors and travelers.",
  ...
  {
    id: "slo-cal-poly-wiki",
    text: "The California Polytechnic School at San Luis Obispo was established in 1901 and opened in 1902 — a vocational college teaching agriculture and mechanics, one of the new institutions shaping our county in the early twentieth century.",
  ...
  {
    id: "slo-gold-rush-wiki",
    text: "The California Gold Rush of 1849 drew fortune-seekers from every corner of the world and transformed the state's economy, politics, and population — forces that reached even our quiet Central Coast as Americans poured into California after statehood.",
